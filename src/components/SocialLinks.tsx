...
/**
 * SVG wrapper for social link icons (Instagram, LinkedIn, GitHub).
...
export function LinksBackgroundImageAndText({
  ...
  const content = (
    <p
      className={`font-['Michelle',sans-serif] leading-normal relative shrink-0 text-[#a1a1aa] text-base text-nowrap tracking-[0.01em] ${
...
/**
 * Footer social icon row with hover tooltips (LinkedIn, Instagram, GitHub).
