  ...
  },
{
    ...
    colors: [
      ...
      { name: "emerald-600", value: "#059669", usage: "Success hover", tag: "one-off" },
...
export const materials: MaterialToken[] = [
  { name: "Grain overlay", detail: "PNG texture at opacity 0.8 over page headers", usage: "Page header texture", tag: "canonical" },
