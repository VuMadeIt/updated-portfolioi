  ...
  fields: [
    ...
    defineField({
      ...
      of: [
        ...
        defineArrayMember({type: 'phoneVideoSection'}),
        defineArrayMember({type: 'learningsSection'}),
        defineArrayMember({type: 'sectionTitleSection'}),
        defineArrayMember({type: 'gallerySection'}),
        defineArrayMember({type: 'textSection'}),
        defineArrayMember({type: 'imageSection'}),
        defineArrayMember({type: 'overlayImageSection'}),
        ...
        defineArrayMember({type: 'twoColumnTextImageSection'}),
