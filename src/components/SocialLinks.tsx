...
/**
 * SVG wrapper for social link icons (Instagram, LinkedIn, GitHub, Devpost).
...
export function LinksBackgroundImageAndText({
  ...
  const content = (
    <p
      className={`font-['Lucas',sans-serif] leading-normal relative shrink-0 text-[#a1a1aa] text-base text-nowrap tracking-[0.01em] ${
...
const SOCIAL_ICONS = [
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/beinglucasvu",
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/bigmanvu/",
...
/**
 * Footer social icon row with hover tooltips (LinkedIn, Instagram, GitHub, Devpost).
